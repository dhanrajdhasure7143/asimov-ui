...
export class columnList{
    ...
    public databaseConnections_column = [
      ...
      public invoice_column=[
        ...
        {ColumnName: "status_converted",DisplayName: "Status",filterWidget: "dropdown",filterType: "text",ShowGrid: true,sort: true,ShowFilter:true,dropdownList:['Paid','Voided'],status_icon:true},
        {ColumnName: "action",DisplayName: "Actions",ShowGrid: true,sort: false,ShowFilter:false},
      ];
     ...
     //EzAsk Admin screens coloumns
      ...
      public custom_tasks = [
        ...
        { ColumnName: "createdAt", DisplayName: "Created By", filterWidget: "normal", ShowFilter: true, filterType: "text", ShowGrid: true, sort: true, multi: true, multiOptions: ["createdBy", "createdAt"], userProfile: true, datePipe: true, userProfileKey: "createdBy" },
