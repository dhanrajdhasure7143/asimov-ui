...
export class columnList{
    ...
    public databaseConnections_column = [
      ...
      public invoice_column=[
        ...
        {ColumnName: "status_converted",DisplayName: "Status",filterWidget: "dropdown",filterType: "text",ShowGrid: true,sort: true,ShowFilter:true,dropdownList:['Paid','Voided'],status_icon:true,width:"flex: 0 0 12rem"},
        {ColumnName: "action",DisplayName: "Actions",ShowGrid: true,sort: false,ShowFilter:false},
      ];
