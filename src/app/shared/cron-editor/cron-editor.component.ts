    ...
    public regenerateCron() {
        ...
        switch (this.activeTab) {
            case "minutes":
                ...
                break;
            case "hourly":
                this.cron = `${this.isCronFlavorQuartz ? this.state.hourly.seconds : ''} ${this.state.hourly.minutes} */${this.state.hourly.hours} * * ${this.weekDayDefaultChar} ${this.yearDefaultChar}`.trim();
                break;
            case "daily":
