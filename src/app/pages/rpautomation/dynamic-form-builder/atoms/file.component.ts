...
template:`
    <div [formGroup]="form">
      <div  class="drop-container dropzone" dropZone (dropped)="field.onUpload($event,field)" >
        <input [attr.disabled]="feilddisable" class="form-control custom-file-input" style = "opacity: 1;" type="file" [id]="field.id" multiple="" [formControlName]="field.name+'_'+field.id" (change)="field.onUpload($event,field)">
      </div>
