export class RpaDragHints{
    public rpaWorkspaceHints = [
        { selector:'#botStatus', description:'Bot Statistics',showNext:true },
        { selector:'#zoominzoomout', description:'Zoom-In & Zoom-Out the Activity Area',showNext:true  },
        ...
        { selector:'#dragandrop', description:'Configure Bot by Drag and Drop Activities',showNext:true },
