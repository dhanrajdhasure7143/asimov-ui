...
export class RpaBotFormComponent implements OnInit {
  ...
  ngOnChanges(changes:SimpleChanges){
    if(!this.isCreateForm && this.botDetails!=undefined)
    {
      ...
      let selectedcategory=this.categoriesList.find(item=>item.categoryName==this.botDetails.department).categoryId
      this.botForm.get("botName").setValue(this.botDetails.botName);
      this.botForm.get("department").setValue(selectedcategory);
      this.botForm.get("botDescription").setValue(this.botDetails.botDescription);
