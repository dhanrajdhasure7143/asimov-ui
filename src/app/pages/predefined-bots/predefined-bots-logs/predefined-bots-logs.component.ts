...
export class PredefinedBotsLogsComponent implements OnInit {
    ...
    ngOnInit() {
      ...
      //   this.rest.getPredefinedBotLogs(this.logsData).pipe(filter(data => Array.isArray(data)),map(runs=>this.assignEnvironmentNamesToProcessRuns(runs))).subscribe((response:any) =>{
