          ...
          for (var i = 0; i < this.model2.length; i++) {
            if (this.model2[i].from == "Start" || this.model2[i].to == "End") {
              ...
              if (this.performanceValue == true) {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: '', labelType: "html", style: "stroke: #333; stroke-width: 3px;stroke-dasharray: 5, 5;marker-end:url(#arrow);fill:none;",
                  arrowheadStyle: "fill: #333", curve: d3.curveBasis, arrowhead: "normal"
                })
              } else {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: this.model2[i].text, labelType: "html", style: "stroke: #333; stroke-width: 3px; stroke-dasharray: 5, 5;marker-end:url(#arrow);fill:none;",
                  arrowheadStyle: "fill: #333", curve: d3.curveBasis, arrowhead: "normal"
                })
              }
            } else {
              ...
              if (this.model2[i].days <= maxLinkCount) {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: this.model2[i].text, labelType: "html", style: "stroke:#a8a5a5; stroke-width: 3px; fill: none;marker-end:url(#arrow3);",
                  arrowheadStyle: "fill: #333", curve: d3.curveBasis, arrowhead: "normal"
                })
              } else if (this.model2[i].days > maxLinkCount && this.model2[i].days <= maxLinkCount * 2) {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: this.model2[i].text, labelType: "html", style: "stroke:#8a8787; stroke-width: 4.4px; fill: none;marker-end:url(#arrow2);",
                  arrowheadStyle: "fill: #333", curve: d3.curveBasis, arrowhead: "normal"
                })
              } else if (this.model2[i].days > maxLinkCount * 2 && this.model2[i].days <= maxLinkCount * 3) {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: this.model2[i].text, labelType: "html", style: "stroke:#757272;stroke-width: 5.5px; fill: none;marker-end:url(#arrow1);",
                  arrowheadStyle: "fill: #333", curve: d3.curveBasis, arrowhead: "normal"
                })
              } else if (this.model2[i].days > maxLinkCount * 3 && this.model2[i].days <= maxLinkCount * 4) {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: this.model2[i].text, labelType: "html", style: "stroke:#993736;stroke-width: 6px; fill: none;marker-end:url(#arrow);",
                  arrowheadStyle: "fill: #333", curve: d3.curveBasis, arrowhead: "normal"
                })
              } else if (this.model2[i].days > maxLinkCount * 4 && this.model2[i].days < maxLinkCount * 5) {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: this.model2[i].text, labelType: "html", style: "stroke:#a01010;stroke-width: 8px; fill: none;marker-end:url(#arrow);",
                  arrowheadStyle: "fill: #333", curve: d3.curveBasis, arrowhead: "normal"
                })
              } else if (this.model2[i].days == maxCount.days) {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: this.model2[i].text, labelType: "html", style: "stroke:#b1080f;stroke-width: 10px; fill: none;marker-end:url(#arrow);",
                  arrowheadStyle: "fill: #333", curve: d3.curveBasis, arrowhead: "normal"
                })
              }
            }
          ...
          for (var i = 0; i < this.model2.length; i++) {
            if (this.model2[i].from == "Start" || this.model2[i].to == "End") {
              ...
              if (this.model2[i].text <= maxLinkCount) {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: this.model2[i].text, labelType: "html", class: this.class6, style: "stroke: #a8a5a5; stroke-width: 3px;marker-end:url(#arrow3);fill:none;",
                  curve: d3.curveBasis, arrowhead: "normal"
                })
              } else if (this.model2[i].text > maxLinkCount && this.model2[i].text <= maxLinkCount * 2) {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: this.model2[i].text, labelType: "html", class: this.class5, style: "stroke: #8a8787;stroke-width: 4.4px;marker-end:url(#arrow2);fill:none;",
                  curve: d3.curveBasis, arrowhead: "normal"
                })
              } else if (this.model2[i].text > maxLinkCount * 2 && this.model2[i].text <= maxLinkCount * 3) {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: this.model2[i].text, labelType: "html", class: this.class4, style: "stroke:url(#svgGradient);stroke-width: 5.5px; marker-end:url(#arrow1);fill:none;",
                  curve: d3.curveBasis, arrowhead: "normal"
                })
              } else if (this.model2[i].text > maxLinkCount * 3 && this.model2[i].text <= maxLinkCount * 4) {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: this.model2[i].text, labelType: "html", class: this.class3, style: "stroke:url(#svgGradient);stroke-width: 6px; marker-end:url(#arrow4);fill:none;",
                  curve: d3.curveBasis, arrowhead: "normal"
                })
              } else if (this.model2[i].text > maxLinkCount * 4 && this.model2[i].text < maxLinkCount * 5) {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: this.model2[i].text, labelType: "html", class: this.class2, style: "stroke:url(#svgGradient);stroke-width: 8px; marker-end:url(#arrow);fill:none;",
                  curve: d3.curveBasis, arrowhead: "normal"
                })
              } else if (this.model2[i].text == maxCount) {
                g.setEdge(this.model2[i].from, this.model2[i].to, {
                  label: this.model2[i].text, labelType: "html", class: this.class1, style: "stroke:#1E1E1E;stroke-width: 10px;marker-end:url(#arrow);fill:none;",
    ...
    if (fileType == 'svg') {
      ...
      html2canvas(this.exportSVGtoPDF.nativeElement, {
        ...
        if (fileType == 'pdf') {
          ...
          doc.internal.pageSize.height = height - 10;
          ...
          doc.addImage(contentDataURL, 'PNG', -10, 0, width, height, undefined, 'FAST')
          // doc.addImage(contentDataURL, 'PNG', -10, 0, width, height-100)
