        ...
        if (aResources.length == 0 || isAllSelect == false) {
            ...
            this.rest.getPIInsightResourceSelection(reqObj)
                .subscribe((res: any) => {
                    ...
                    if (this.activity_Metrics.length) {
                        ...
                        this.activity_Metrics.forEach((e, m) => {
                            ...
                            // }
                                ...
                                obj1[ e.Activity]=Math.round(duration)
                                obj3[ e.Activity]= Math.round(duration * this.input1)
                                    // name: e.Activity,
                                    // y: duration
                                pieArray.push(e.Activity)
                            let obj = [
                                 e.Activity,
                                 Math.round(duration)
                            ]
                    ...
                    this.loadPeiChart1(activityDuration,pieArray)
                    this.loadPeiChart2(activityCost,pieArray)
                })
        }
    }
    ...
    getActivityMetrics(type: any, selected_variants?: any) {
        ...
        this.rest.getPIVariantActivity(reqObj)
            .subscribe((res: any) => {
                ...
                activityDuration.push(obj1);
                activityCost.push(obj3);
