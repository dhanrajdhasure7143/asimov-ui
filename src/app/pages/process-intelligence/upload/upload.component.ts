...
export class UploadComponent implements OnInit {
  ...
  getDateFormat(){
    ...
    var dateformat;
    var yearformat;
    var dateInput = ["2-23-1122 04:31:10.000 PM","11-22-2222 04:31:10.000 PM","11-22-2222 04:31:10.000 PM"];
    // var dateInput = "12.02.2011 04:31:10 AM";
    // var dateInput = "02/02/20 04:31:10 PM";
    if(dateInput[0].includes('-')){
      splitDate=dateInput[0].split('-')
          if(splitDate[0].length==4){
            ...
            // console.log("splitDate1",splitDate1);
              ...
              var fullDateFormat=yearformat+'-'+dateformat      
                ...
                var fullDateFormat=dateformat+'-'+yearformat
                }
    ...
    var inputDateformat=fullDateFormat+' '+time
    
    console.log("inputDateformat",inputDateformat);
  }
  getFormat(d){
    for (var prop in this.dateFormats) {
          if(moment(d, this.dateFormats[prop],true).isValid()){
             return this.dateFormats[prop];
          }
    }
    return null;
  }
